...
public class ConstantUtil {
    ...
    public static final String AUTHORITY="com.taylor.screenshort";
    ...
    public static final String BROADCAST_FLOAT_BAR_SERVICE_MODIFIED ="broadcast_float_bar_service_modified";
